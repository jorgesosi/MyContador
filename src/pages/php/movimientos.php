<?php session_start();
   ...
   try {    
     ...
     $sql = (' SELECT T1.id,T1.fecha,T1.importe,T1.descripcion,T4.nombre as tipoMovimiento,
      T1.idMovimientosTipo,T2.id as idCuentas,T2.nombre as Cuenta, T2.numero, T3.id as idHogar,
      T3.nombre as Hogar, T3.idUsuarios
