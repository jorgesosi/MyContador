...
@Component({
  selector: 'page-tiposcuentas',
  templateUrl: 'tiposcuentas.html',
})
export class TiposcuentasPage {
  ...
  load()
  {
     this.http.get('http://localhost/Contador//tiposcuentas.php')
  ...
  viewEntry(param)
  {
     this.navCtrl.push('TipocuentaPage', param);
  }
  deleteEntry(param){
      this.navCtrl.push('TipocuentaPage', param);
  }
